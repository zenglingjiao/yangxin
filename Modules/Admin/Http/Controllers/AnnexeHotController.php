...
class AnnexeHotController extends BaseAdminController
{
    /**
     * @Name: 大Banner試圖
    ...
    {
        $title = __('admin::controller.annexe_hot_list');

        return view('admin::annexe.annexe_hot_list',compact('title'));
    }
     ...
     */
    public function list(CommonPageRequest $request, AnnexeHotService $service)
    {
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View
     */
    public function edit(int $id = 0, AnnexeHotService $service)
    {

        $title = __('admin::controller.annexe_hot_edit');
        $model = $id > 0 ? $service->edit($id) : null;


        return view('admin::annexe.annexe_hot_edit', compact('title', 'model'));
    }
     ...
     * @return \Modules\Admin\Services\banner\JSON
     */
    public function add(Request $request, AnnexeHotService $service)
    {
     ...
     * @return \Modules\Admin\Services\banner\JSON
     */
    public function update(Request $request, AnnexeHotService $service)
    {
     ...
     */
    public function del(DelIdRequest $request, AnnexeHotService $service)
    {
