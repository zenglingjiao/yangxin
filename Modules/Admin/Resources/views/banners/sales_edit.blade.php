                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('banner_sales_list')}}">促銷廣告列表</a>
                                </li>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('banner_sales_update')}}",
                api_model_add: "{{route('banner_sales_add')}}",
                ok_jump_url: "{{route('banner_sales_list')}}",
            }
        },
        created: function () {
