                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('banner_team_buy_list')}}">團購Banner列表</a>
                                </li>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('banner_team_buy_update')}}",
                api_model_add: "{{route('banner_team_buy_add')}}",
                ok_jump_url: "{{route('banner_team_buy_list')}}",
            }
        },
        created: function () {
