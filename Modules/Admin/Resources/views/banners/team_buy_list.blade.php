                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('banner_team_buy_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"banner_team_buy_list",

            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('banner_get_team_buy_list')}}",
            api_model_edit:"{{route('banner_team_buy_edit')}}",
            api_model_delete:"{{route('banner_team_buy_del')}}",
        },
        created:function () {
