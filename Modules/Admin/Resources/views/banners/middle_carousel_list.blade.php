                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('banner_middle_carousel_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center" sortable="custom" prop="id" label="ID"></el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"banner_middle_carousel_list",

            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('banner_get_middle_carousel_list')}}",
            api_model_edit:"{{route('banner_middle_carousel_edit')}}",
            api_model_delete:"{{route('banner_middle_carousel_del')}}",
