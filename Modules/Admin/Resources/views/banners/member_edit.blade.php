                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('banner_member_index')}}">會員專區列表</a>
                                </li>
                        ...
                        <el-form ref="form" :rules="form_rules" v-loading="loading" :model="model" label-width="120px"
                            ...
                            <el-row>
                                ...
                                <template v-for="(item, index) in model.info">
                                 <el-form-item label="排序" prop="jump_url" >
                                        <span >@{{index+1}}</span>
                                    </el-form-item>
                                <el-form-item label="圖片" :rules="{
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('banner_member_update')}}",
                api_model_add: "{{route('banner_member_add')}}",
                ok_jump_url: "{{route('banner_member_index')}}",
            }
        },
        created: function () {
            ...
            if (json_model) {
                ...
                for (var i=0;i<this.init_num;i++){
                    this.model.info.push( {id:'', img:'', jump_type:1, jump_url:''},)
                }
            }
