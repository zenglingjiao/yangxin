    ...
    <div class="page-content-wrapper">
        ...
        <el-dialog title="編輯" :visible.sync="dialogFormVisible">
            <el-form :model="form">
                ...
                <el-form-item label="圖片" prop="img" :label-width="formLabelWidth">
                    <div v-if="form.img">
                        <img :src="form.img" style="width: 100px; height: 100px">
                    </div>
                    <el-upload
                            name="file"
                            drag
                            action="{{route('upload')}}"
                            :on-success="(res,file)=>{return uploadSuccess(res,file,'img')}"
                    >
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "banner_kayou_list",
            api_get_tabel: "{{route('banner_kayou_list')}}",
            api_model_update: "{{route('banner_kayou_update')}}",
            api_model_delete: "{{route('banner_kayou_del')}}",
        },
        created: function () {
