...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "banner_middle_activity_list",
            api_get_tabel: "{{route('banner_middle_activity_list')}}",
            api_model_update: "{{route('banner_middle_activity_update')}}",
            api_model_delete: "{{route('banner_middle_activity_del')}}",
        },
        created: function () {
