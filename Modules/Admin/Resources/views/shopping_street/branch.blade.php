                ...
                <div class="card-body">
                    <div class="form-item">
                        <div class="form-group ml-auto">
                            <a href="{{route('branch_edit')}}/{{$sid}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="store_info.store_no" label="店家編號"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="branch_name" label="公司名稱">
                                    <template slot-scope="scope">
                                        <template v-if="scope.row.type == 2">
                                            @{{scope.row.store_info.company_name + '-' + scope.row.branch_name}}
                                        </template>
                                        <template v-else>
                                ...
                                <el-table-column header-align="center" align="center"  prop="tel" label="聯絡電話"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="branch_name" label="門市地址">
                                    <template slot-scope="scope">
                                        @{{scope.row.branch_city + scope.row.branch_district + scope.row.branch_address}}
                                    </template>
                                </el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"branch_list",
            api_get_tabel:"{{route('shopping_street_branch_list')}}",
            api_model_index:"{{route('shopping_street_branch')}}",
            api_model_edit:"{{route('shopping_street_branch_edit')}}",
        },
        created:function () {
        ...
        methods: {
            ...
            edit_model:function (index,row) {
                ...
                window.location.href = this.api_model_edit+"/"+this.model.sid+"/"+row.id;
            },
