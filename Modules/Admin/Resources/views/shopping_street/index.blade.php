                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="id" label="商圈編號"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="shopping_street_name" label="商圈名稱"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="liaisons_name" label="聯絡人"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="liaisons_tel" label="聯絡手機"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="shopping_street_name" label="點數名稱"></el-table-column>
                                ...
                                <el-table-column header-align="center" align="center"  label="操作">
                                    <template slot-scope="scope">
                                        <el-button
                                                size="mini"
                                                type="primary"
                                                @click="edit_model_branch(scope.$index, scope.row)">商圈店家管理</el-button>
                                        <el-button
                                                size="mini"
                                                type="primary"
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"shopping_street_list",
            api_get_tabel:"{{route('shopping_street_list')}}",
            api_model_index:"{{route('shopping_street_index')}}",
            api_model_edit:"{{route('shopping_street_edit')}}",
            api_table_status:"{{route('shopping_street_status')}}",
        },
        created:function () {
        ...
        methods: {
            ...
            edit_model_branch:function (index,row) {
                ...
                window.location.href = "{{route('shopping_street_branch')}}"+"/"+row.id;
            },
