                        ...
                        <el-row>
                            <el-form-item label="類型" prop="type">
                                <el-select v-model="model.type" placeholder="請選擇">
                                    ...
                                    <el-option label="店家" :value="2"></el-option>
                                </el-select>
                            </el-form-item>

                            <el-form-item label="商圈/店家編號" prop="number">
                                <el-input v-model="model.number"></el-input>
                            </el-form-item>

                            <el-form-item label="方案" prop="purchase_scheme_id">
                                <el-select v-model="model.purchase_scheme_id" placeholder="請選擇">
                                    <el-option v-for="x in purchase_scheme_list" :label="x.scenario_name" :value="x.id"></el-option>
                                </el-select>
                            </el-form-item>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('points_sold_update')}}",
                ok_jump_url: "{{route('points_sold_index')}}/",
            }
        },
        created: function () {
            ...
            var purchase_scheme_list = JSON.parse(decodeURIComponent('{{urlencode(json_encode((isset($purchase_scheme) ? $purchase_scheme : null)))}}'.replace(/\+/g, " ")));
            if (purchase_scheme_list) {
                this.purchase_scheme_list = purchase_scheme_list;
            }
        },
        mounted: function () {
