                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('welcome_ad_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"welcome_ad_list",

            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('welcome_get_ad_list')}}",
            api_model_edit:"{{route('welcome_ad_edit')}}",
            api_model_delete:"{{route('welcome_ad_del')}}",
        },
        created:function () {
