                ...
                <div class="card-body d-flex flex-wrap">
                    <template>
                        <el-radio-group v-model="model.status" style="margin-bottom: 30px;">
                            ...
                            <el-radio-button  name="1" label="1">上架</el-radio-button>
                            <el-radio-button  name="0" label="0">下架</el-radio-button>
                        </el-radio-group>
                    </template>
                </div>
                <div class="card-body d-flex flex-wrap">
                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('welcome_app_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                        ...
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column type="selection" prop="id"></el-table-column>
                                   <el-table-column header-align="center" align="center" sortable="custom" prop="name" label="名稱"></el-table-column>
                                <el-table-column header-align="center" align="center" prop="phone_img" label="縮圖">
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"welcome_app_list",
            api_get_tabel:"{{route('welcome_get_app_list')}}",
            api_model_edit:"{{route('welcome_app_edit')}}",
            api_model_delete:"{{route('welcome_app_del')}}",
        },
        created:function () {
