                        ...
                        <div class="my-el-table">
                            ...
                            >
                                ...
                                <el-table-column header-align="center" align="center" prop="status"
                                                 label="狀態">
                                    <template slot-scope="scope">
                                        @{{['','待審核','審核通過','審核失敗'][scope.row.register_audit_status]}}
                                    </template>
                                </el-table-column>
                                <el-table-column header-align="center" align="center" label="操作">
                                    <template slot-scope="scope">
                                        <el-button
                                            ...
                                            <template v-if="scope.row.register_audit_status == 1">
                                                編輯
                                            </template>
                                            <template v-else>
                                                查看
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "store_register_list",
            api_get_tabel: "{{route('store_register_list')}}",
            api_model_index: "{{route('store_register_index')}}",
            api_model_edit: "{{route('store_register_edit')}}",
        },
        created: function () {
