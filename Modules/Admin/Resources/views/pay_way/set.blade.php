...
@include('admin::partials._include_header_aside')
    ...
    <div class="page-content-wrapper">
                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="nper" label="期數"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="rate" label="手續費"></el-table-column>
        ...
        <!-- 彈窗 -->
        <el-dialog title="手續費設置" :visible.sync="dialogFormVisible">
            <el-form :model="form">
                <el-form-item label="名稱" prop="name"  :label-width="formLabelWidth">
                    <el-input v-model="form.name"></el-input>
                </el-form-item>
                <el-form-item label="期數" prop="nper" :label-width="formLabelWidth">
                    <el-select v-model="form.nper" placeholder="请选择类型">
                        <el-option v-for="item in options" :label=item.v :value=item.k></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="手續費" prop="rate"  :label-width="formLabelWidth">
                    <el-input  v-model="form.rate"></el-input>
                </el-form-item>
                <el-form-item label="可分期銀行" prop="note"  :label-width="formLabelWidth">
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"pay_poundage_list",

            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('pay_poundage_list',$id)}}",
            api_model_update:"{{route('pay_poundage_update')}}",
            api_model_delete:"{{route('pay_poundage_del')}}",
        },
        created:function () {
