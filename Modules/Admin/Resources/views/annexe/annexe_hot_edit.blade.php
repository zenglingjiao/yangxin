                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('annexe_hot_index')}}">熱門館別列表</a>
                                </li>
                    ...
                    <div class="card-body">
                        <el-form ref="form" :rules="form_rules" v-loading="loading" :model="model" label-width="120px"
                            ...
                            <el-row>
                                ...
                                <el-form-item label="跳轉館別" prop="annexe_id" >
                                    <el-select v-model="item.annexe_id" filterable>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('annexe_hot_update')}}",
                api_model_add: "{{route('annexe_hot_add')}}",
                ok_jump_url: "{{route('annexe_hot_index')}}",
            }
        },
        created: function () {
