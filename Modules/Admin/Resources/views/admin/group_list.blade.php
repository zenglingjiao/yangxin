                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('group_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            role_list:[],
            api_get_tabel:"{{route('get_group_list')}}",
            api_model_edit:"{{route('group_edit')}}",
            api_model_delete:"{{route('group_del')}}",
            api_table_status:"{{route('group_status')}}",
        },
        created:function () {
