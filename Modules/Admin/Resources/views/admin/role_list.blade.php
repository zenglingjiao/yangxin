        ...
        <div class="page-content">
            <div class="card radius-15">
                <div class="card-body d-flex flex-wrap">
                    <div class="list-item">
                        <label class="list-item-label">名稱</label>
                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('role_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center" prop="status" v-if="false" label="狀態">
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"role_list",

            api_get_tabel:"{{route('get_role_list')}}",
            api_model_edit:"{{route('role_edit')}}",
            api_model_delete:"{{route('role_del')}}",
            api_table_status:"{{route('role_status')}}",
        },
        created:function () {
