...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "store_advertising_list",
            api_get_tabel: "{{route('store_advertising_list')}}",
            api_model_index: "{{route('store_advertising_index')}}",
            api_model_edit: "{{route('store_advertising_edit')}}",
            api_table_status: "{{route('store_advertising_status')}}",
            api_model_delete: "{{route('store_advertising_del')}}",
