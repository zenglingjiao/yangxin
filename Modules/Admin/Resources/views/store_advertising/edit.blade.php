                    ...
                    <div class="card radius-15">
                        <div class="card-body">
                            <el-row>
                                ...
                                <el-form-item label="存摺" prop="imgs">
                                ...
                                <el-form-item label="上架時間" prop="company_name">
                                    <template>
                                        <el-radio v-model="model.is_perpetual" :label="0">
                                            <el-date-picker
                                                v-model="model.up_at"
                                        ...
                                        <el-radio v-model="model.is_perpetual" :label="1">永久</el-radio>
                                    </template>
                                </el-form-item>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('store_advertising_update')}}",
                ok_jump_url: "{{route('store_advertising_index')}}/",
            }
        },
        created: function () {
