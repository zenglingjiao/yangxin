                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            ...
                            >
                                ...
                                <el-table-column header-align="center" align="center" prop="scenario_sort" label="商圈編號">
                                    <template slot-scope="scope">
                                        @{{scope.row.shopping_street_info.shopping_street_no}}
                                    </template>
                                </el-table-column>
                                <el-table-column header-align="center" align="center" prop="scenario_name" label="商圈名稱">
                                    <template slot-scope="scope">
                                        @{{scope.row.shopping_street_info.shopping_street_name}}
                                    </template>
                                </el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "points_grant_list",
            api_get_tabel: "{{route('points_grant_list')}}",
            api_model_index: "{{route('points_grant_index')}}",
        },
        created: function () {
