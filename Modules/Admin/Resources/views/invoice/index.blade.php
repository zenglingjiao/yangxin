...
@include('admin::partials._include_header_aside')
    ...
    <div class="page-content-wrapper">
                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="name" label="受捐贈機關或團體名稱"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="code" label="捐贈碼"></el-table-column>
        ...
        <!-- 彈窗 -->
        <el-dialog title="發票捐贈" :visible.sync="dialogFormVisible">
            <el-form :model="form">
                <el-form-item label="受捐贈機關或團體名稱" prop="name"  :label-width="formLabelWidth">
                    <el-input v-model="form.name"></el-input>
                </el-form-item>
                <el-form-item label="捐贈碼" prop="code"  :label-width="formLabelWidth">
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('invoice_list')}}",
            api_model_update:"{{route('invoice_update')}}",
            api_model_delete:"{{route('invoice_del')}}",
        },
        created:function () {
