                    ...
                    <div class="card radius-15">
                        <div class="card-body">
                            <el-row>
                                ...
                                <el-form-item label="請款類型" prop="number">
                                    <el-select v-model="model.type" placeholder="">
                                        <el-option label="陽信點數" :value="1"></el-option>
                                        <el-option label="商圈點數" :value="2"></el-option>
                                        <el-option label="自家點數" :value="3"></el-option>
                                    </el-select>
                                </el-form-item>

                                <el-form-item label="請款點數" prop="number">
                                    <template v-if="model.id>0">
                                        @{{model.points}}
                                    </template>
                                    <template v-else>
                                ...
                                <el-form-item label="請款申請日期" prop="apply_date">
                                    2021-09-01 11:10
                                </el-form-item>
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('request_funds_update')}}",
                ok_jump_url: "{{route('request_funds_index')}}/",
