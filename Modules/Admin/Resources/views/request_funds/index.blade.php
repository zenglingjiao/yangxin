                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            ...
                            >
                                ...
                                <el-table-column header-align="center" align="center" prop="store_info.corporate_brand"
                                                 label="公司品牌"></el-table-column>
                                <el-table-column header-align="center" align="center" prop="store_info.tax_id"
                                                 label="統一編號"></el-table-column>
                                <el-table-column header-align="center" align="center" prop="points"
                                                 label="退款點數"></el-table-column>
                                <el-table-column header-align="center" align="center" prop="created_at"
                                                 label="建立時間"></el-table-column>
                                <el-table-column header-align="center" align="center" prop="status"
                                                 label="狀態">
                                    <template slot-scope="scope">
                                        @{{['待處理','已撥款'][scope.row.status]}}
                                    </template>
                                </el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model: {},
            history_name: "request_funds_list",
            api_get_tabel: "{{route('request_funds_list')}}",
            api_model_index: "{{route('request_funds_index')}}",
            api_model_edit: "{{route('request_funds_edit')}}",
        },
        created: function () {
