                    ...
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="scenario_sort" label="排序"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="type" label="類型">
                                    <template slot-scope="scope">
                                        @{{['-','陽信點','自家點'][scope.row.type]}}
                                    </template>
                                </el-table-column>
                                <el-table-column header-align="center" align="center"  prop="scenario_name" label="方案名稱"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="points" label="點數"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="original_price" label="原價"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="special_offer" label="特價"></el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"purchase_scheme_list",
            api_get_tabel:"{{route('purchase_scheme_list')}}",
            api_model_index:"{{route('purchase_scheme_index')}}",
            api_model_edit:"{{route('purchase_scheme_edit')}}",
            api_table_status:"{{route('purchase_scheme_status')}}",
        },
        created:function () {
