                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('season_recommend_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"season_recommend_list",

            role_list:[],
            group_list:[],
            api_get_tabel:"{{route('season_recommend_list')}}",
            api_model_edit:"{{route('season_recommend_edit')}}",
            api_model_delete:"{{route('season_recommend_del')}}",
        },
        created:function () {
