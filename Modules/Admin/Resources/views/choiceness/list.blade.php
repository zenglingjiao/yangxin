                ...
                <div class="card-body">
                    <div class="form-item">
                        ...
                        <div class="form-group ml-auto">
                            <a href="{{route('choiceness_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            loading: false,
            clean_model:{},
            history_name:"choiceness_list",

            api_get_tabel:"{{route('choiceness_list')}}",
            api_model_edit:"{{route('choiceness_edit')}}",
            api_model_delete:"{{route('choiceness_del')}}",
        },
        created:function () {
