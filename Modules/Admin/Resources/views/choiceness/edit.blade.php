                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('choiceness_index')}}">精選專區列表</a>
                                </li>
                    ...
                    <div class="card-body">
                        <el-form ref="form" :rules="form_rules" v-loading="loading" :model="model" label-width="120px"
                            ...
                            <el-row>
                                ...
                                <el-form-item label="圖片" :rules="{required: true, message: '請上傳圖片', trigger: 'blur'}">
                                    <div v-if="item.img">
    ...
    var vue_obj = new Vue({
        ...
        data: function () {
            return {
                ...
                loading: false,
                form_is_top: false,
                api_model_edit: "{{route('choiceness_update')}}",
                api_model_add: "{{route('choiceness_add')}}",
                ok_jump_url: "{{route('choiceness_index')}}",
            }
        },
        created: function () {
            ...
            if (json_model) {
                ...
                for (var i=0;i<this.init_num;i++){
                    this.model.info.push({id:'', img:'', jump_type:"",jump_url:''},)
                }
            }
