                    ...
                    <div class="card-body">
                        <el-form ref="form" :rules="form_rules" v-loading="loading" :model="model" label-width="120px"
                            ...
                            <el-row>
                                ...
                                <el-form-item label="搜尋熱門字" prop="keyword">
                                    <el-input type="textarea" v-model="model.keyword"></el-input>
                                </el-form-item>
        ...
        data: function () {
            return {
                ...
                form_rules: {
                    ...
                    keyword: [
                        {required: true, message: '請輸入关键词', trigger: 'blur'}
                    ],
                },
                clean_model: {},
                loading: false,
                form_is_top: false,
                api_model_update: "{{route('keyword_hot_update')}}",
            }
        },
        created: function () {
