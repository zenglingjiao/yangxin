                    ...
                    <div class="card-body">
                        <el-form ref="form" :rules="form_rules" v-loading="loading" :model="model" label-width="120px"
                            ...
                            <el-row>
                                ...
                                <el-form-item label="SMTP Server" prop="server">
                                    <el-input v-model="model.server"></el-input>
                                </el-form-item>

                                <el-form-item label="SMTP Port" prop="port">
                                    <el-input v-model="model.port" show-password></el-input>
                                </el-form-item>

                                <el-form-item label="E-mail" prop="email">
                                    <el-input v-model="model.email" show-password></el-input>
                                </el-form-item>
        ...
        data: function () {
            return {
                ...
                form_rules: {
                    ...
                    server: [
                        {required: true, message: '請輸入服務地址', trigger: 'blur'}
                    ],
                    port: [
