                ...
                <div class="card-body">
                    <div class="form-item">
                        <div class="form-group ml-auto">
                            <a href="{{route('industry_category_edit')}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="name" label="產業名稱"></el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            api_get_tabel:"{{route('industry_category_list')}}",
            api_model_index:"{{route('store_index')}}",
            api_model_edit:"{{route('industry_category_edit')}}",
        },
        created:function () {
