                    ...
                    <div class="card-body">
                        ...
                        <el-row>
                            ...
                            <el-form-item label="分店名稱" prop="branch_name">
                                <el-input v-model="model.branch_name"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="門市地址" prop="branch_city">
                                <el-select v-model="model.branch_city" placeholder="縣市">
                                    <el-option label="台北" value="台北市"></el-option>
                                    <el-option label="高雄" value="高雄市"></el-option>
                                </el-select>
                            </el-form-item>

                            <el-form-item prop="branch_district">

                                <el-select v-model="model.branch_district" placeholder="地區">
                                    <el-option label="盐埕区" value="盐埕区"></el-option>
                                    <el-option label="鼓山区" value="鼓山区"></el-option>
                                </el-select>
                            </el-form-item>

                            <el-form-item prop="branch_address">
                                <el-input v-model="model.branch_address"  placeholder="詳細地址"></el-input>
                            </el-form-item>
                    ...
                    <div class="card-body">
                        <el-row>
                            ...
                            <el-form-item label="備註" prop="branch_business_hours">
                                <el-input v-model="model.branch_business_hours.remark"  placeholder="備註"></el-input>
                            </el-form-item>
                    ...
                    <div class="card-body">
                        <el-row>
                            <el-form-item label="狀態" prop="status">
                                <el-radio v-model="model.status" :label="1">有</el-radio>
                                <el-radio v-model="model.status" :label="0">無</el-radio>
                            </el-form-item>
