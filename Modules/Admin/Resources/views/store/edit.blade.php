                        ...
                        <div class="card-body">
                            <el-row>
                                ...
                                <el-form-item label="公司地址" prop="name">
                                    <el-form-item>
                                        <el-radio @change="same('same_reg')" v-model="model.same_reg" label="1">同註冊地址
                                        </el-radio>
                                    </el-form-item>

                                    <el-form-item>
                                        <el-radio @change="same('same_reg')" v-model="model.same_reg"
                                                  label=""></el-radio>
                                        ...
                                        <el-select v-model="model.corp_district" :disabled="is_true_reg"
                                                   placeholder="地區">
                                            <el-option label="盐埕区" value="盐埕区"></el-option>
                                            <el-option label="鼓山区" value="鼓山区"></el-option>
                                        </el-select>

                                        <el-input v-model="model.corp_address" :disabled="is_true_reg"
                                ...
                                <el-form-item label="公司品牌" prop="corporate_brand">
                                    <el-radio @change="same('same_corp_name')" v-model="model.same_corp_name" label="1">
                                        同公司名稱
                                    </el-radio>
                                    <el-form-item>
                                        <el-radio @change="same('same_corp_name')" v-model="model.same_corp_name"
                                                  label=""></el-radio>
                                ...
                                <el-form-item label="產業類別" prop="industry_category_id">
                                    <el-select v-model="model.industry_category_id" placeholder="產業類別">
                                        <el-option :label="x.name" :key="x.id" :value="x.id"
                                                   v-for="x in industry_category"></el-option>
                                    </el-select>
                                </el-form-item>

                                <el-form-item label="合約日期" prop="industry_category_id">
                                    <el-date-picker
                                        v-model="model.up_at"
                    ...
                    <div class="card radius-15">
                        <div class="card-body">
                            <el-row>
                                ...
                                <el-form-item label="店家點購買權限" prop="store_buy_power">
                                    <el-radio v-model="model.store_buy_power" :label="1">有</el-radio>
                                    <el-radio v-model="model.store_buy_power" :label="0">無</el-radio>
                                </el-form-item>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        created: function () {
            ...
            if (this.model.identity_card_obverse) this.identity_card_obverse_list = [{
                url: this.model.identity_card_obverse,
                field: 'identity_card_obverse'
            }];
            if (this.model.identity_card_reverse) this.identity_card_reverse_list = [{
                url: this.model.identity_card_reverse,
                field: 'identity_card_reverse'
            }];
            if (this.model.business_registration_certificate) this.business_registration_certificate_list = [{
                url: this.model.business_registration_certificate,
                field: 'business_registration_certificate'
            }];
