                ...
                <div class="card-body">
                    <div class="form-item">
                        <div class="form-group ml-auto">
                            <a href="{{route('branch_edit')}}/{{$pid}}" class="btn btn-info m-1 px-5 radius-30">新增</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div class="my-el-table">
                            <el-table :data="table_data" stripe highlight-current-row border
                                ...
                                <el-table-column header-align="center" align="center"  prop="branch_name" label="店家編號"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="branch_name" label="分店名稱"></el-table-column>
                                <el-table-column header-align="center" align="center"  prop="branch_name" label="商圈認證"></el-table-column>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            ...
            api_model_edit:"{{route('branch_edit')}}",
        },
        created:function () {
        ...
        methods: {
            ...
            edit_model:function (index,row) {
                ...
                window.location.href = this.api_model_edit+"/"+this.model.pid+"/"+row.id;
            },
