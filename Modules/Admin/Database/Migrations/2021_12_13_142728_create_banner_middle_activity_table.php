...
class CreateBannerMiddleActivityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yx_banners_middle_activity', function (Blueprint $table) {
            $table->comment = '中間活動表';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('yx_banners_middle_activity');
    }
}
