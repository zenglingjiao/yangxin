...
class CreateBannersTeamBuyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yx_banners_team_buy', function (Blueprint $table) {
            $table->comment = '團購banner表';
    ...
    {
        Schema::dropIfExists('yx_banners_team_buy');
    }
}
