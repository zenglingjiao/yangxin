...
class CreateBannersBigTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yx_banners_big', function (Blueprint $table) {
            $table->comment = '大banner表';
    ...
    {
        Schema::dropIfExists('yx_banners_big');
    }
}
