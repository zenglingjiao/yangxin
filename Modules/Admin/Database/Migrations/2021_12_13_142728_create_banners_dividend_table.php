...
class CreateBannersDividendTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yx_banners_dividend', function (Blueprint $table) {
            $table->comment = '紅利專區banner表';
    ...
    {
        Schema::dropIfExists('yx_banners_dividend');
    }
}
